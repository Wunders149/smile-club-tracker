      ...
      <div className="space-y-6">
        ...
        <div className="print-only">
          <div ref={printRef} className="p-0 bg-white text-black w-full font-sans">
            ...
            <div className="print-header flex justify-between items-center border-b-2 border-gray-900 pb-6">
                ...
                return (
                  <table key={month} className="month-section">
                    <thead className="month-header-row">
                      <tr>
                        <th className="text-left p-0 pb-3">
                          <div className="flex items-baseline justify-between border-b border-gray-900/30">
                        ...
                        <tr key={ev.id} className="event-row">
                          <td className="py-2.5 px-1">
                            <div className="flex items-start gap-4">
                              <div className="text-base font-bold text-primary tabular-nums min-w-[24px]">
                                {format(new Date(ev.date), 'dd')}
                              </div>
                              <div className="flex-1 min-w-0">
                                <div className="font-bold text-gray-900 leading-tight mb-0.5 uppercase text-xs tracking-tight">{ev.name}</div>
                                <div className="flex flex-wrap items-center gap-x-3 gap-y-0.5 text-[9px] font-medium text-gray-500 uppercase tracking-tight">
            ...
            <div className="mt-12 pt-8 border-t border-gray-100 flex justify-between items-end text-[8px] font-bold uppercase tracking-[0.15em] text-gray-400">
              <div>
                <p>Generated {format(new Date(), 'yyyy.MM.dd HH:mm')}</p>
                <p className="mt-1 text-gray-300">Smile Club Tracker Internal System</p>
              </div>
              <div className="text-right">
                <p className="text-gray-900 mb-1">For The Patients!</p>
                <p className="text-[6px] text-gray-300 tracking-[0.3em]">Confidential activity log</p>
              </div>
            </div>
          </div>
        </div>
